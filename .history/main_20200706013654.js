  ...
  for (let j = 0; j < lists.length; j++) {
    ...
    list.addEventListener("dragenter", function (e) {
	  ...
	  console.log(this.style.cursor);
		document.getElementById(e.target.id).style.cursor = 'no-drop';
		document.getElementById(e.target.id).setAttribute('draggable',false);
	  ;
    });
    ...
    list.addEventListener("dragleave", function (e) {
	  ...
	  cantAccess = false;
	  document.getElementById(e.target.id).style.cursor = '';
		document.getElementById(e.target.id).setAttribute('draggable',true);
    });
